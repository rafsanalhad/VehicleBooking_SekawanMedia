...
class VehicleSeeder extends Seeder
{
    public function run()
    {
        DB::table('vehicles')->insert([
            ...
            ['type' => 'cargo', 'plate_number' => 'XYZ789', 'model' => 'Hino 500', 'year' => 2018, 'ownership_type' => 'rental', 'status' => 'available', 'fuel_consumption' => 20.0],
            ...
            ['type' => 'cargo', 'plate_number' => 'LMN234', 'model' => 'Isuzu ELF', 'year' => 2019, 'ownership_type' => 'company', 'status' => 'available', 'fuel_consumption' => 15.5],
            ...
            ['type' => 'cargo', 'plate_number' => 'JKL890', 'model' => 'Mitsubishi Fuso', 'year' => 2017, 'ownership_type' => 'rental', 'status' => 'available', 'fuel_consumption' => 18.0],
            ...
            ['type' => 'cargo', 'plate_number' => 'PQR123', 'model' => 'Mercedes-Benz Actros', 'year' => 2020, 'ownership_type' => 'company', 'status' => 'available', 'fuel_consumption' => 22.5],
            ...
            ['type' => 'cargo', 'plate_number' => 'VWX789', 'model' => 'Volvo FH16', 'year' => 2019, 'ownership_type' => 'rental', 'status' => 'available', 'fuel_consumption' => 25.0],
            ...
            ['type' => 'cargo', 'plate_number' => 'BCD345', 'model' => 'Hino Ranger', 'year' => 2018, 'ownership_type' => 'company', 'status' => 'available', 'fuel_consumption' => 17.5],
            ...
            ['type' => 'cargo', 'plate_number' => 'HIJ901', 'model' => 'Freightliner Cascadia', 'year' => 2020, 'ownership_type' => 'rental', 'status' => 'available', 'fuel_consumption' => 24.0],
            ...
            ['type' => 'cargo', 'plate_number' => 'NOP567', 'model' => 'Kenworth T680', 'year' => 2017, 'ownership_type' => 'company', 'status' => 'available', 'fuel_consumption' => 26.0],
            ...
            ['type' => 'cargo', 'plate_number' => 'TUV123', 'model' => 'Peterbilt 579', 'year' => 2018, 'ownership_type' => 'rental', 'status' => 'available', 'fuel_consumption' => 23.0],
