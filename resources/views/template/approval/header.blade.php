...
<head>
    ...
    <title>Penerimaan / Approval</title>
        ...
        <aside id="sidebar"
            ...
            <div class="flex flex-col h-full justify-between">
                <div>
                    <div class="p-4 text-xl font-bold text-center bg-gray-900 flex items-center justify-between">
                        <a href="#" class="block">Penerimaan Panel</a>
                    ...
                    <nav class="mt-6">
                        <ul id="navList">
                            <li>
                                <a href="{{route('approvalDashboard')}}" id="dashboardNav" class="block p-4 hover:bg-gray-700 transition duration-300 flex items-center">
         ...
         <div class="flex-1 flex flex-col">
            <header class="bg-white shadow-md px-6 py-4 flex items-center justify-between">
                <h1 class="text-xl font-bold lg:block md:hidden sm:hidden hidden"> Penerimaan Menu</h1>
