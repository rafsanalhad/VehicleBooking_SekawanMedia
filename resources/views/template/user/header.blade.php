    ...
    <div class="flex min-h-screen">
            ...
            <div class="flex flex-col h-full justify-between">
                <div>
                    <div class="p-4 text-xl font-bold text-center bg-gray-900 flex items-center justify-between">
                        <a href="#" class="block">User Panel</a>
                    ...
                    <nav class="mt-6">
                        <ul id="navList">
                            <li>
                                <a href="{{ route('userDashboard') }}" id="dashboardNav"
                                    class="block p-4 hover:bg-gray-700 transition duration-300 flex items-center">
                                    <i class="fa-solid fa-house-user mr-2"></i> Dashboard
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('userBookings') }}" id="pengajuanNav"
                                    class="block p-4 hover:bg-gray-700 transition duration-300 flex items-center">
                                    <i class="fa-solid fa-file-alt mr-2"></i> Menu Pengajuan
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('userReturns') }}" id="pengembalianNav"
                                    class="block p-4 hover:bg-gray-700 transition duration-300 flex items-center">
                ...
                <div class="p-4 text-center">
                    <form action="{{ route('logout') }}" method="POST">
                        @csrf
                        <button
                            class="bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-md w-full transition duration-300">
        ...
        <div class="flex-1 flex flex-col">
            <header class="bg-white shadow-md px-6 py-4 flex items-center justify-between">
                <h1 class="text-xl font-bold lg:block md:hidden sm:hidden hidden"> User Menu</h1>
